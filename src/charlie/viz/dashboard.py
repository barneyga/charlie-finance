...
def main():
    ...
    # Row 1: Regime label + Fear/Greed gauge + key metrics
    ...
    # Row 2: Fear/Greed component breakdown
    if fg["components"]:
    ...
    # Row 4: Macro regime signal table
    with st.expander("Macro Regime Signals"):
        signal_rows = []
    ...
    if not cal_df.empty:
        # Top row: next dates for key releases
    ...
    if not gld.empty:
        ...
        # Row 2: Gold/silver ratio + Real yields vs Gold
        ...
        # Row 3: Silver vs Copper + Commodities normalized
    ...
    # ============================================================
    st.header("Cross-Asset Divergence")

    # Row 1: Correlation + Stocks vs Bonds
    ...
    # Row 2: HY-IG spread + Credit ETFs
    ...
    # ============================================================
    st.header("Geographic Rotation")

    # Row 1: US vs Intl + Europe
    ...
    # ============================================================
    st.header("AI & Tech Sub-sectors")

    # Row 1: QQQ vs IGV vs SOXX + NVDA vs QQQ
    ...
    st.divider()
    st.caption(
        f"Data sources: FRED, Yahoo Finance | "
